...
/*
####### Función para liberar memoria de visit ########
# 
#  ENTRADA: Una lista enlazada de puzzles (visitados).
#  
#  SALIDA:  Nada.
# 
#  ACCIÓN:  Recorra la lista enlazada eliminando cada
# 			puzzle y nodo de esta lista.
# 
######################################################
*/
...
/*
####### Función para liberar memoria del arbol ########
# 
#  ENTRADA: Un puzzle-arbol.
#  
#  SALIDA:  Nada.
# 
#  ACCIÓN:  Hace un recorrido en profundidad liberando
# 			la memoria de cada nodo hijo (puzzle)
# 			presente.
# 
#######################################################
*/
...
#  SALIDA:  Nada.
# 
#  ACCIÓN:  Recorre la lista de visitados e imprime
# 			cada puzzle presente en esta. 
# 
######################################################
*/
...
/*
####### Función que imprime un puzzle ########
# 
#  ENTRADA: Puzzle en formato de cadena de
# 			caracteres.
#
#  SALIDA:  Nada.
# 
#  ACCIÓN:  Recorre el puzzle imprimiendo sus
# 			caracteres en forma de matriz 3x3.
# 
##############################################
*/
...
# 
#  ENTRADA: Un arbol-puzzle y una lista de visitados.
#  
#  SALIDA:  Nada.
# 
#  ACCIÓN:  Realiza un recorrido en profundidad
#  			buscando un puzzle resultado extrayendo
#  			la cantidad de movimientos. Este dato se
